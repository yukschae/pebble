...
export default function LandingPage() {
  ...
  useEffect(() => {
    setShowStars(true)
    const authState = { user: user ? "logged-in" : "not-logged-in", loading }
    console.log("Landing page - Auth state:", authState)
    setDebugInfo(JSON.stringify(authState))
