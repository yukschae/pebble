...
▼ パッションシャトルとは
ユーザーの興味を掛け合わせて生み出す、将来に繋がり社会に貢献できる興味=探究テーマ。重要なのは、従来の具体的な職業名ではなく、多少抽象的でもクリエイティブなキャリアパスをタイトルとすること。詳細説明では、具体的なイメージと社会との繋がりの可能性をいくつか例示する。中学生でもわかるレベルの言葉で回答すること。
